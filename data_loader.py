...
class PulseDataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        im = []
        im.append(np.expand_dims(np.array(img1, dtype=np.float32),axis=0))
        im.append(np.expand_dims(np.array(img2, dtype=np.float32),axis=0))
        im.append(np.expand_dims(np.array(img3, dtype=np.float32),axis=0))
        im.append(np.expand_dims(np.array(img4, dtype=np.float32),axis=0))
